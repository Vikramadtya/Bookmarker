...
import {
  ...
  useDeleteFolder,
  useUpdateFolder,
} from "@/domains/folders/application/useFolders";
import { useAuth } from "@/domains/identity/application/useAuth";
import { cn } from "@/lib/utils";
import { ThemeToggle } from "@/shared/ui/ThemeToggle";
import { useFolderNavigation } from "@/domains/folders/application/useFolderNavigation";
import { useFolderCreation } from "@/domains/folders/application/useFolderCreation";

import DeleteFolderModal from "./DeleteFolderModal";
import PublicFolderModal from "./PublicFolderModal";
import UnlockFolderModal from "./UnlockFolderModal";
...
export default function FolderSidebar() {
  ...
  // Navigation — active folder + expand/collapse per collection
  const {
    activeFolder,
    setActiveFolder,
    expandedCollections,
  ...
  // Folder creation — inline input state
  const {
    showInputFor,
    newFolderName,
    setNewFolderName,
    openInputFor: setShowInputFor,
    handleCreateFolder,
    isPending: createFolderPending,
  } = useFolderCreation({
    onSuccess: (_created, parentId) => {
