...
const Sparkle = ({ id, x, y, color, delay, scale, duration }) => {
  return (
    <svg
      key={id}
      ...
      style={{
        ...
        animation: `sparkle-ping ${duration}s ease-in-out infinite`,
...
export const SparklesText = ({
  ...
  const sparkles = useMemo(() => {
    return Array.from({ length: sparklesCount }).map((_, i) => {
      ...
      return { id: i, x: starX, y: starY, color, delay, scale, duration };
    });
